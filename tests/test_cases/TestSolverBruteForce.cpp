...
TEST(Unit_Solver_BruteForce, InvalidSudoku_ReturnFalse)
{
...
TEST(Unit_Solver_BruteForce, ValidSudoku_ReturnTrue)
{
...
TEST(Unit_Solver_BruteForce, ValidSudoku_ResolvedCorrectly)
{
